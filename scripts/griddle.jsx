...
var Griddle = React.createClass({
  ...
  componentWillMount: function () {
    ...
    self.rowSettings = new RowProperties(
      self.props.rowMetadata,
      (self.props.useCustomTableRowComponent && self.props.customTableRowComponent) ?
        self.props.customTableRowComponent :
        GridRow,
      self.props.useCustomTableRowComponent
    );
    ...
    return (
      <div className="griddle-footer">
        {this.props.useCustomPagerComponent ?
          <CustomPaginationContainer next={this.nextPage} previous={this.previousPage} currentPage={currentPage}
          ...
          <GridPagination useGriddleStyles={this.props.useGriddleStyles} next={this.nextPage}
  ...
  getColumnSelectorSection: function (keys, cols) {
    return this.state.showColumnChooser ? (
      <GridSettings columns={keys} selectedColumns={cols} setColumns={this.setColumns}
  ...
  getCustomGridSection: function () {
    return <this.props.customGridComponent data={this.props.results}
  ...
  getNoDataSection: function () {
    if (this.props.customNoDataComponent != null) {
      return (<div className={this.props.noDataClassName}>
